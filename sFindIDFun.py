...
def sFindDataType(sText):
    ...
    if cc != 9998:
        ...
        output(sText + ' —— [' + str(int(sText, 16)) + '] ' +
               fileList[cc].decode('utf-8').split('=')[1])
    else:
...
def sShowNData(sDataType, sData):
    ...
    if sDataType == 'date_time':
        tmpText = str(int(sData[0:4], 16)) + '-' + sData[4:6] + '-' + sData[6:8] + ' 星期' + sData[8:10] + \
            ' ' + sData[10:12] + ':' + sData[12:14] + ':' + \
            sData[14:16] + ':' + str(int(sData[16:20], 16))

    if sDataType == 'date':
        tmpText = str(int(sData[0:4], 16)) + '-' + sData[4:6] + \
            '-' + sData[6:8] + ' 星期' + sData[8:10]

    if sDataType == 'time':
        tmpText = sData[0:2] + ':' + sData[2:4] + ':' + sData[4:6]

    if sDataType == 'date_time_s':
        tmpText = str(int(sData[0:4], 16)) + '-' + sData[4:6] + '-' + sData[6:8] + \
            ' ' + sData[8:10] + ':' + sData[10:12] + ':' + sData[12:14]
